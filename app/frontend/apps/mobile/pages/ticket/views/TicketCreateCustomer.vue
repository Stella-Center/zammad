  ...
  [
    {
      ...
      messagesClass: 'pt-2',
      inputClass:
        '$reset formkit-input block bg-transparent grow border-b-[0.5px] border-white outline-none text-center text-xl placeholder:text-black placeholder:text-opacity-50',
      props: {
...
<template>
  ...
  >
    <FormKit
      ...
      @click="moveStep()"
    >
      {{ lastStepName === activeStep ? $t('Submit') : $t('Continue') }}
    </FormKit>
  </footer>
</template>
